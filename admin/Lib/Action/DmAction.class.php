...
class DmAction extends Action {
    ...
    private $all=array(
    	'mdmk'=>'Dm',//NB
  		...
  		'jn'=>array(),//NB
      //自己的全部+f的显示的东西
  		'para'=>array('dmid'=>'dmID','dmnm'=>'住宿名称'),//NB
  		//抛去不是zabojin的属性针对para
      'notself'=>array(),
       ##########modify 添加修改中不需要展示和理会的属性 针对para
      'no_update'=>array('dmid',),
      #####update的时候允许为空的值 针对zabojin刨掉不然显示的update字段后
      'allowempty'=>array(),

      'hide_fld'=>array('dmid'),//NB
      'hide_cdt'=>array('dmid'),//NB
  		
    //   'spccdtls'=>array('spccdt_0'=>array('dmid<>0','dmID不为0【废话只是测试】')),
  		// 'odrls'=>array('dmnm'),
    //   'spccdt_dflt'=>array('spccdt_0'),
    //   'odr_dflt'=>array('dmnm'=>'ASC'),

...
<div class='col-md-12' style='padding-top: 20px;'>
	...
	<div class='mingxi'>
	专业信息：<input type="hidden" id='f_std_sttid' value="1"><input type='hidden' id='f_stdxqpmj_xqid' value="<?php echo ($mo['f_stdxqpmj_xqid']); ?>">
	<table>
	<tr>
	<td>
	年级：
...
$(function(){
	$('#panduan').click(function(){
		...
		// if($.trim($('#stdpst').val())!=''&&(!(!isNaN($.trim($('#stdpst').val()))&&$.trim($('#stdpst').val()).length==6))))
		// 	return false;
		// }

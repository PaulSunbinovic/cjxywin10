...
class ZzmmAction extends Action {
    ...
    private $all=array(
    	'mdmk'=>'Zzmm',//NB
  		...
  		'jn'=>array(),//NB
      //自己的全部+f的显示的东西
  		'para'=>array('zzmmid'=>'zzmmID','zzmmnm'=>'政治面貌名称'),//NB
  		//抛去不是zabojin的属性针对para
      'notself'=>array(),
       ##########modify 添加修改中不需要展示和理会的属性 针对para
      'no_update'=>array('zzmmid',),
      #####update的时候允许为空的值 针对zabojin刨掉不然显示的update字段后
      'allowempty'=>array(),

      'hide_fld'=>array('zzmmid'),//NB
      'hide_cdt'=>array('zzmmid'),//NB
  		
    //   'spccdtls'=>array('spccdt_0'=>array('zzmmid<>0','zzmmID不为0【废话只是测试】')),
  		// 'odrls'=>array('zzmmnm'),
    //   'spccdt_dflt'=>array('spccdt_0'),
    //   'odr_dflt'=>array('zzmmnm'=>'ASC'),
      ...
      //hide的fld必须有，他们虽然不显示但是必须选择，这样才能在第一次进入query的时候，隐藏属性可以被调用，特别是id和fid
  		'fld_dflt'=>array('zzmmid','zzmmnm'),//NB
  		'cdt_dflt'=>array(),//NB

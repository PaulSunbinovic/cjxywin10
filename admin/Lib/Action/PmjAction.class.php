...
class PmjAction extends Action {
    ...
    private $all=array(
      ...
      'multicorrect'=>array(),
  		...
  		'jn'=>array('tb_grd ON f_pmj_grdid=grdid','tb_bxxs ON f_pmj_bxxsid=bxxsid','tb_cc ON f_pmj_ccid=ccid','tb_kl ON f_pmj_klid=klid','tb_xxxs ON f_pmj_xxxsid=xxxsid','tb_zsfw ON f_pmj_zsfwid=zsfwid','tb_xz ON f_pmj_xzid=xzid','tb_mj ON f_pmj_mjid=mjid','tb_stt ON f_pmj_sttid=sttid'),//NB
      //自己的全部+f的显示的东西
  		'para'=>array('pmjid'=>'PMJID','f_pmj_grdid'=>'年级','grdnm'=>'年级名称','f_pmj_bxxsid'=>'办学形式','bxxsnm'=>'办学形式名称','f_pmj_ccid'=>'层次','ccnm'=>'层次名称','f_pmj_klid'=>'科类','klnm'=>'科类名称','f_pmj_xxxsid'=>'学习形式','xxxsnm'=>'学习形式名称','f_pmj_zsfwid'=>'招生范围','zsfwnm'=>'招生范围名称','f_pmj_xzid'=>'学制','xznm'=>'学制年限','pmjdm'=>'专业代码','f_pmj_mjid'=>'专业','mjnm'=>'专业名称','f_pmj_sttid'=>'站点','sttnm'=>'站点名称'),//NB
  		//抛去不是zabojin的属性针对para
      'notself'=>array('grdnm','bxxsnm','ccnm','klnm','xxxsnm','zsfwnm','xznm','mjnm','sttnm'),
       ##########modify 添加修改中不需要展示和理会的属性 针对para
      'no_update'=>array('pmjid','grdnm','bxxsnm','ccnm','klnm','xxxsnm','zsfwnm','xznm','mjnm','sttnm'),
      ...
      'hide_cdt'=>array('pmjid','grdnm','bxxsnm','ccnm','klnm','xxxsnm','zsfwnm','zxnm','mjnm','sttnm'),//NB
    ...
    //   'odr_dflt'=>array('bbbnm'=>'ASC'),
      ...
      //hide的fld必须有，他们虽然不显示但是必须选择，这样才能在第一次进入query的时候，隐藏属性可以被调用，特别是id和fid
  		'fld_dflt'=>array('pmjid','f_pmj_grdid','grdnm','f_pmj_bxxsid','bxxsnm','f_pmj_ccid','ccnm','f_pmj_klid','klnm','f_pmj_xxxsid','xxxsnm','f_pmj_zsfwid','zsfwnm','f_pmj_xzid','xznm','pmjdm','f_pmj_mjid','mjnm','f_pmj_sttid','sttnm'),//NB
  		'cdt_dflt'=>array(),//NB
  		...
  		'defaultls'=>1,//默认枚举//NB
  		##########view
  		'no_view'=>array('pmjid','f_pmj_grdid','f_pmj_bxxsid','f_pmj_ccid','f_pmj_klid','f_pmj_xxsid','f_pmj_grdid','f_pmj_zsfwid','f_pmj_xzid','f_pmj_mjid','f_pmj_sttid'),
	   
      #########删除提醒
      'deleteconfirm'=>'确定要删除此条记录？',
      #####转义
      'transmean'=>array('xznm'=>array('2.5'=>'2.5','3'=>'3','5'=>'5')),//NB
      #####默认值
      'dfltvalue'=>array(),

...
class MjAction extends Action {
  ...
  //聚合
    private $all=array(
      ...
      'jn'=>array(),//NB
      //自己的全部+f的显示的东西
      'para'=>array('mjid'=>'mjID','mjnm'=>'专业名称','mjdsc'=>'专业描述'),//NB
    ...
    //   'spccdtls'=>array('spccdt_0'=>array('mjid<>0','mjID不为0【废话只是测试】')),
      // 'odrls'=>array('mjnm'),
    //   'spccdt_dflt'=>array('spccdt_0'),
    //   'odr_dflt'=>array('mjnm'=>'ASC'),
      ...
      'fld_dflt'=>array('mjid','mjnm','mjdsc'),//NB
      'cdt_dflt'=>array(),//NB

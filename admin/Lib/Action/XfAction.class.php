...
class XfAction extends Action {
  ...
  //聚合
    private $all=array(
      ...
      'jn'=>array('tb_grd ON f_xf_grdid=grdid','tb_stt ON f_xf_sttid=sttid','tb_bxxs ON f_xf_bxxsid=bxxsid','tb_cc ON f_xf_ccid=ccid','tb_kl ON f_xf_klid=klid'),//NB
      //自己的全部+f的显示的东西
      'para'=>array('xfid'=>'xfID','f_xf_grdid'=>'年级','grdnm'=>'年级名称','f_xf_sttid'=>'站点','sttnm'=>'站点名称','f_xf_bxxsid'=>'办学形式','bxxsnm'=>'办学形式名称','f_xf_ccid'=>'层次','ccnm'=>'层次名称','f_xf_klid'=>'科类','klnm'=>'科类名称','xfsm'=>'学费数目','jckwfsm'=>'教材考务费数目'),//NB
      //抛去不是zabojin的属性针对para
      'notself'=>array('grdnm','sttnm','bxxsnm','ccnm','klnm'),
       ##########modify 添加修改中不需要展示和理会的属性 针对para
      'no_update'=>array('xfid','grdnm','sttnm','bxxsnm','ccnm','klnm'),
      #####update的时候允许为空的值 针对zabojin刨掉不然显示的update字段后
      'allowempty'=>array('xfsm','jckwfsm'),

      'hide_fld'=>array('xfid','f_xf_grdid','f_xf_sttid','f_xf_bxxsid','f_xf_ccid','f_xf_klid'),//NB
      'hide_cdt'=>array('xfid','grdnm','sttnm','bxxsnm','ccnm','klnm'),//NB
    ...
    //   'odr_dflt'=>array('bbbnm'=>'ASC'),
      ...
      'fld_dflt'=>array('xfid','f_xf_grdid','grdnm','f_xf_sttid','sttnm','f_xf_bxxsid','bxxsnm','f_xf_ccid','ccnm','f_xf_klid','klnm','xfsm','jckwfsm'),//NB
      'cdt_dflt'=>array(),//NB
      ...
      'defaultls'=>1,//默认枚举//NB
      ##########view
      'no_view'=>array('xfid','f_xf_grdid','f_xf_sttid','f_xf_bxxsid','f_xf_ccid','f_xf_klid'),
